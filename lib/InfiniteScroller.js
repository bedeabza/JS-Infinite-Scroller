    ...
    var self = {
        ...
        update: function (left) {
            ...
            if (!this.ignore && this.lastPosition !== normalized) { //only execute if needed
                ...
                state.progress = normalized <= 0 ? absoluteProgress : 1 - absoluteProgress;
                ...
                if (this.passedEdge()) {
                    this.executeBetweenIndexes(this.executeEdgePass, (state.currentIndex === this.lastCurrentIndex ? 1 : 0));
                }
